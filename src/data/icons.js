...
export const ICONS = [
  ...
  { id: 'figma', name: 'Figma', category: 'Frontend', keywords: 'design ui ux prototype', svg: tile('#1e1e1e', `<circle cx="26" cy="20" r="8" fill="#f24e1e"/><circle cx="40" cy="32" r="8" fill="#1abcfe"/><circle cx="26" cy="32" r="8" fill="#a259ff"/><circle cx="26" cy="44" r="8" fill="#0acf83"/>`) },

  /* Backend */
  { id: 'nodejs', name: 'Node.js', category: 'Backend', keywords: 'javascript server npm', svg: nodejs },
  { id: 'express', name: 'Express', category: 'Backend', keywords: 'node api rest', svg: mono('#111827', 'Ex') },
  { id: 'django', name: 'Django', category: 'Backend', keywords: 'python web', svg: mono('#092e20', 'dj') },
  { id: 'flask', name: 'Flask', category: 'Backend', keywords: 'python micro api', svg: mono('#111827', 'Fl') },
  { id: 'fastapi', name: 'FastAPI', category: 'Backend', keywords: 'python async api', svg: mono('#059669', 'API', '#ffffff', 19) },
  { id: 'laravel', name: 'Laravel', category: 'Backend', keywords: 'php framework', svg: mono('#ff2d20', 'Lv') },
  { id: 'spring', name: 'Spring', category: 'Backend', keywords: 'java boot', svg: mono('#6db33f', 'Sp') },
  { id: 'dotnet', name: '.NET', category: 'Backend', keywords: 'csharp microsoft', svg: mono('#512bd4', '.NET', '#ffffff', 15) },
  { id: 'graphql', name: 'GraphQL', category: 'Backend', keywords: 'api query schema', svg: mono('#e10098', 'GQL', '#ffffff', 17) },
  { id: 'rest', name: 'REST API', category: 'Backend', keywords: 'api http endpoint', svg: mono('#0ea5e9', 'REST', '#ffffff', 14) },

  /* Databases */
  { id: 'mysql', name: 'MySQL', category: 'Databases', keywords: 'sql relational db', svg: cylinder('#00758f', '#005c73', 'SQL') },
  { id: 'postgresql', name: 'PostgreSQL', category: 'Databases', keywords: 'postgres sql relational db', svg: cylinder('#336791', '#27506f', 'PG') },
  { id: 'mongodb', name: 'MongoDB', category: 'Databases', keywords: 'nosql document db', svg: mongodb },
  { id: 'sqlite', name: 'SQLite', category: 'Databases', keywords: 'embedded sql db', svg: cylinder('#003b57', '#002a3f', 'lite') },
  { id: 'redis', name: 'Redis', category: 'Databases', keywords: 'cache key value memory', svg: cylinder('#d82c20', '#a81f16', '') },
  { id: 'oracle', name: 'Oracle DB', category: 'Databases', keywords: 'sql enterprise db', svg: mono('#c74634', 'ORA', '#ffffff', 17) },
  { id: 'sqlserver', name: 'SQL Server', category: 'Databases', keywords: 'microsoft mssql db', svg: cylinder('#a91d22', '#7d1519', 'MS') },
  { id: 'firebase', name: 'Firebase', category: 'Databases', keywords: 'google realtime nosql', svg: mono('#ffca28', 'FB', '#111827') },
  { id: 'supabase', name: 'Supabase', category: 'Databases', keywords: 'postgres backend', svg: mono('#3ecf8e', 'Sb', '#052e1b') },
  { id: 'database', name: 'Database', category: 'Databases', keywords: 'generic data storage db', svg: cylinder('#64748b', '#475569', '') },

  /* Cloud & DevOps */
  { id: 'linux', name: 'Linux', category: 'Cloud & DevOps', keywords: 'tux kernel unix open source', svg: linux },
  { id: 'ubuntu', name: 'Ubuntu', category: 'Cloud & DevOps', keywords: 'linux distro debian', svg: tile('#e95420', `<circle cx="32" cy="32" r="16" fill="none" stroke="#ffffff" stroke-width="4"/><circle cx="46" cy="32" r="5" fill="#ffffff"/><circle cx="25" cy="20" r="5" fill="#ffffff"/><circle cx="25" cy="44" r="5" fill="#ffffff"/>`) },
  { id: 'debian', name: 'Debian', category: 'Cloud & DevOps', keywords: 'linux distro', svg: mono('#a80030', 'Deb', '#ffffff', 17) },
  { id: 'redhat', name: 'Red Hat', category: 'Cloud & DevOps', keywords: 'linux rhel enterprise', svg: mono('#ee0000', 'RH') },
  { id: 'git', name: 'Git', category: 'Cloud & DevOps', keywords: 'version control commit branch', svg: git },
  { id: 'github', name: 'GitHub', category: 'Cloud & DevOps', keywords: 'git repo open source', svg: github },
  { id: 'gitlab', name: 'GitLab', category: 'Cloud & DevOps', keywords: 'git ci repo', svg: mono('#fc6d26', 'GL', '#ffffff', 20) },
  { id: 'docker', name: 'Docker', category: 'Cloud & DevOps', keywords: 'container image devops', svg: docker },
  { id: 'kubernetes', name: 'Kubernetes', category: 'Cloud & DevOps', keywords: 'k8s orchestration container', svg: kubernetes() },
  { id: 'aws', name: 'AWS', category: 'Cloud & DevOps', keywords: 'amazon cloud ec2 s3', svg: tile('#232f3e', label('aws', '#ff9900', 20, 28) + `<path d="M16 42c10 6 22 6 32 0" stroke="#ff9900" stroke-width="3.5" fill="none" stroke-linecap="round"/>`) },
  { id: 'azure', name: 'Azure', category: 'Cloud & DevOps', keywords: 'microsoft cloud', svg: tile('#0078d4', `<path d="M26 10h14l14 34H36l-6-10h8L26 10z" fill="#ffffff"/><path d="M24 16L10 48h20l4-8-10-2z" fill="#ffffff" fill-opacity="0.75"/>`) },
  { id: 'gcp', name: 'Google Cloud', category: 'Cloud & DevOps', keywords: 'gcp google cloud', svg: tile('#ffffff', cloudShape('#4285f4') + label('GCP', '#1a73e8', 13, 52)) },
  { id: 'cloud', name: 'Cloud', category: 'Cloud & DevOps', keywords: 'generic cloud hosting', svg: cloudShape('currentColor'), mono: true },
  { id: 'terraform', name: 'Terraform', category: 'Cloud & DevOps', keywords: 'iac infrastructure hashicorp', svg: mono('#7b42bc', 'Tf') },
  { id: 'ansible', name: 'Ansible', category: 'Cloud & DevOps', keywords: 'automation config redhat', svg: mono('#111827', 'An') },
  { id: 'jenkins', name: 'Jenkins', category: 'Cloud & DevOps', keywords: 'ci cd pipeline build', svg: mono('#d24939', 'CI') },
  { id: 'nginx', name: 'NGINX', category: 'Cloud & DevOps', keywords: 'web server proxy', svg: mono('#009639', 'N', '#ffffff', 30) },
  { id: 'apache', name: 'Apache', category: 'Cloud & DevOps', keywords: 'httpd web server', svg: mono('#d22128', 'Ap') },
  { id: 'server', name: 'Server', category: 'Cloud & DevOps', keywords: 'rack hosting datacenter', svg: serverRack, mono: true },
  ...
  /* Tools */
  { id: 'vscode', name: 'VS Code', category: 'Tools', keywords: 'editor ide microsoft', svg: tile('#0065a9', `<path d="M44 10l10 5v34l-10 5-20-19-10 8-6-4 12-11-12-11 6-4 10 8z" fill="#ffffff"/>`) },
  { id: 'postman', name: 'Postman', category: 'Tools', keywords: 'api testing rest', svg: mono('#ff6c37', 'Pm') },
  { id: 'jira', name: 'Jira', category: 'Tools', keywords: 'agile tickets atlassian scrum', svg: mono('#0052cc', 'Jira', '#ffffff', 16) },
  { id: 'slack', name: 'Slack', category: 'Tools', keywords: 'chat team communication', svg: mono('#4a154b', 'Sl') },
  { id: 'notion', name: 'Notion', category: 'Tools', keywords: 'notes docs wiki', svg: mono('#ffffff', 'N', '#111827', 30) },
  { id: 'grafana', name: 'Grafana', category: 'Tools', keywords: 'dashboard monitoring metrics', svg: mono('#f46800', 'Gf') },
  { id: 'prometheus', name: 'Prometheus', category: 'Tools', keywords: 'monitoring metrics alerts', svg: mono('#e6522c', 'Pr') },
  { id: 'virtualbox', name: 'VirtualBox', category: 'Tools', keywords: 'vm virtualization lab', svg: mono('#183a61', 'VB') },
  { id: 'vmware', name: 'VMware', category: 'Tools', keywords: 'vm virtualization esxi', svg: mono('#607078', 'VM') },
  { id: 'windows', name: 'Windows', category: 'Tools', keywords: 'microsoft os desktop', svg: tile('#0078d4', `<rect x="12" y="12" width="18" height="18" fill="#ffffff"/><rect x="34" y="12" width="18" height="18" fill="#ffffff"/><rect x="12" y="34" width="18" height="18" fill="#ffffff"/><rect x="34" y="34" width="18" height="18" fill="#ffffff"/>`) },
  { id: 'terminal', name: 'Terminal', category: 'Tools', keywords: 'console shell cli command', svg: terminalGlyph, mono: true },
  ...
  { id: 'graduation', name: 'Graduation cap', category: 'Shapes & Symbols', keywords: 'student school learning atc', svg: gradGlyph, mono: true },
